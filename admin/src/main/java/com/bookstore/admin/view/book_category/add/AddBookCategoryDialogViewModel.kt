...
import com.bookstore.admin.model.formated.book.AddBookCategoryResponse
...
class AddBookCategoryDialogViewModel(
    ...
    var addBookCategoryResponse : LiveData<AddBookCategoryResponse> = _addBookCategoryResponse
    ...
    fun addBookCategory(addBookCategoryRequest: AddBookCategoryRequest) = viewModelScope.launch(Dispatchers.IO) {
        try {
            ...
            _addBookCategoryResponse.postValue(AddBookCategoryResponse(RetrofitStatus.SUCCESS, result))
