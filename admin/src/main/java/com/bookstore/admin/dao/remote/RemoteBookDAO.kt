...
interface RemoteBookDAO {
    ...
    ): BookModel // mengembalikan BookModel sesuai dengan response JSON yang ada di swagger
    ...
    @DELETE("api/rest/book-category/deletedById/{book_category_id}")
