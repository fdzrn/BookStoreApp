...
object Retrofit {
    fun getClientAdmin(baseUrl: String = API_BASE_URL): Retrofit =
        Retrofit.Builder()
            .baseUrl(baseUrl)
            .client(
    ...
    fun Throwable.printRetrofitError() {
        ...
        when (this) {
            is IOException -> Log.e(
                ...
                "Network Error in Retrofit | because: ${this.cause} | message: ${this.message}"
            )
            is HttpException -> Log.e(
                this::class.java.simpleName,
                "Http Exception in Retrofit | because: ${this.cause} | message: ${this.message}"
            )
            else -> Log.e(
                this::class.java.simpleName,
                "Unknown Error in Retrofit | because: ${this.cause} | message: ${this.message}"
            )
        }
    }
}