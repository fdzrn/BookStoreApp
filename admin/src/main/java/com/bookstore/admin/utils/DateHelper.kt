...
object DateHelper {
    fun newFormatDate(oldFormat: String, newFormat: String = DATE_TIME_DEFAULT_FORMAT): String =
        LocalDateTime.parse(oldFormat, DateTimeFormatter.ofPattern(DATE_TIME_DATABASE_FORMAT))
