package com.bookstore.client.view.main.fragment.cart.adapter
...
class CartAdapter(private val cartItemListener: CartItemListener) : RecyclerView.Adapter<CartAdapter.ViewHolder>(), CartFilterable {
    ...
    override fun onBindViewHolder(holder: CartAdapter.ViewHolder, position: Int) = holder.bind(position, carts[position])
