...
import kotlinx.android.synthetic.main.activity_book_detail.view.image_cover
import kotlinx.android.synthetic.main.activity_book_detail.view.text_category
import kotlinx.android.synthetic.main.item_list_book.view.*

class BookAdapter(private val bookItemListener: BookItemListener) :RecyclerView.Adapter<BookAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: BookAdapter.ViewHolder, position: Int) = holder.bind(books[position])
