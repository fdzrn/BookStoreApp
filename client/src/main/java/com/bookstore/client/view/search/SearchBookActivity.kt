package com.bookstore.client.view.search
...
import com.bookstore.client.view.search.adapter.SearchBookAdapter
import com.bookstore.client.view.search.adapter.SearchBookItemListener
        ...
        searchBookViewModel.searchBookResponse.observe(this, Observer {
            ...
            when (it.status) {
                RetrofitStatus.SUCCESS -> it.list?.let { list ->
                    ...
                    if (!filterByTypeFromIntent) (intent.getParcelableArrayListExtra<BookType>(
                        FILTER_BY_TYPE
                    ))?.let { filter ->
