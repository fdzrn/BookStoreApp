package com.bookstore.client.ui.checkout.fragment.payment.adapter
...
import com.bookstore.client.ui.checkout.fragment.payment.PaymentItemListener
...
class PaymentAdapter (private val paymentItemListener: PaymentItemListener): RecyclerView.Adapter<PaymentAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: PaymentAdapter.ViewHolder, position: Int) = holder.bind(transactionDetails[position])
