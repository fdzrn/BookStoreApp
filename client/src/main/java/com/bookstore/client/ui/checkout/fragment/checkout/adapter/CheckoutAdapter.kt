...
class CheckoutAdapter(private val checkoutItemListener: CheckoutItemListener) : RecyclerView.Adapter<CheckoutAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CheckoutAdapter.ViewHolder, position: Int) = holder.bind(carts[position])
