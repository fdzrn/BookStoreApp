...
import com.bookstore.client.config.AppConfig.OAUTH_DEFAULT_ACCOUNT_PASSWORD
import com.bookstore.client.config.AppConfig.OAUTH_DEFAULT_ACCOUNT_USERNAME
    ...
    override fun onStart() {
        ...
        button_signin.setOnClickListener {
            ...
            if (username == OAUTH_DEFAULT_ACCOUNT_USERNAME && password == OAUTH_DEFAULT_ACCOUNT_PASSWORD) {
                ...
                input_username.error = if (username == OAUTH_DEFAULT_ACCOUNT_USERNAME) "We can't find your username" else null
                input_password.error = if (password == OAUTH_DEFAULT_ACCOUNT_PASSWORD) "We can't find your password" else null
